...
//SQL queries
const CREATE_TINY_URL_ENTRY = "INSERT INTO tiny_url(long_url,short_url) VALUES($1, $2) RETURNING short_url";
const GET_LONG_URL_BY_TINY_URL = "SELECT long_url from tiny_url WHERE short_url=$1";
...
const convertToShortUrlAndSave = longUrl =>{
    return new Promise ((resolve,reject)=>{
        const tinyUrlPrefix = "https://aktiny.com/";
